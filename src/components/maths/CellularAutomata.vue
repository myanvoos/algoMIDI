...
const { currentCells, rowCount, columnCount, updateAutomata, clearGrid } =
	useAutomata(automataConfig.value)
...
const { drawGrid, handleMouseClick, updateGrid, clearGridDisplay } =
	useAutomataRenderer({
